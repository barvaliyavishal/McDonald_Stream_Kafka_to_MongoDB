...
CREATE STREAM macd_orders_raw_stream (
    order_id STRING,
    customer_id STRING,
    order_total DOUBLE,
...
CREATE STREAM macd_payments_raw_stream (
    payment_id STRING,
    order_id STRING,
...
CREATE STREAM macd_orders_payments_raw_joined AS
SELECT 
